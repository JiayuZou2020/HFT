...
class ArgoverseDataset(CustomDataset):
    """Argoverse dataset.

    In segmentation map annotation for Argoverse, 0 stands for background. ``reduce_zero_label`` is fixed to True.
    The ``img_suffix`` is fixed to '.jpg' and ``seg_map_suffix`` is fixed to
    '.png'.
    """
    CLASSES = ('drivable_area', 'vehicle', 'pedestrian', 'large_vehicle',
               'bicycle', 'bus', 'trailer', 'motorcycle')

    PALETTE = [[120, 120, 120], [4,200,3], [4,250,7], [120,120,80],
                [235,255,7],[140,140,140],[204,5,255],[224,5,255],
                [8, 255, 51]]
