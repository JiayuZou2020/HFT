_base_ = [
    '../_base_/models/pyva_swin.py','../_base_/datasets/kittiobject.py',
    '../_base_/default_runtime.py','../_base_/schedules/schedule_20k.py'
]
backbone_norm_cfg = dict(type='LN', requires_grad=True)
model = dict(
    type='kd_pyva_BEVSegmentor',
    ...
    neck=dict(
        ...
        start_level=1,
        num_outs=5),
    transformer = dict(type='Pyva_combine_simple_fpn_force_transformer',size = (32,32)),
    decode_head=dict(
...
train_pipeline = [
    ...
    dict(type='LoadAnnotations', reduce_zero_label=False, with_calib_kittiobject=True, imdecode_backend='pyramid'),
