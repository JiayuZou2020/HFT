_base_ = [
    '../_base_/models/pyva_swin.py','../_base_/datasets/nuscenes_without_occlusion.py',
...
train_pipeline = [
    ...
    dict(type='RandomFlipNuscenes', prob=0.5),
...
data = dict(samples_per_gpu=12, workers_per_gpu=2,
