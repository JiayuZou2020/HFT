_base_ = [
    '../_base_/models/pyva_swin.py','../_base_/datasets/argoverse.py',
...
model = dict(
    ...
    neck=dict(
        ...
        start_level=1,
        num_outs=5),
    transformer = dict(type='Pyva_combine_simple_force_transformer',size = (32,32)),
    decode_head=dict(
...
train_pipeline = [
    ...
    dict(type='RandomFlipArgoverse', prob=0.5),
